...
#Make Figure 2c
```{r}
DMC_Data_csv <- read_csv(file = "BCB_545_Final_Project_DMCs_Dryad.csv")

#Mutate a new column to have percent loss/gains
DMC_Data_csv$diff <- DMC_Data_csv$'High' - DMC_Data_csv$'West/Low'

#Select "Altitudinal" data from the "Type" column in the data file
Altitudinal_data <- subset(DMC_Data_csv, Type == "Altitudinal")
...
#Mutate a new column to have percent loss/gains
DMC_Data_csv$diff_d <- DMC_Data_csv$'East' - DMC_Data_csv$'West/Low'

#Select "Spacial" data from the "Type" column in the data file
Spatial_data <- subset(DMC_Data_csv, Type == "Spatial")
...
```{r}
#Mutate a new column to have percent loss/gains
DMC_Data_csv$diff_e <- DMC_Data_csv$'Mid_Dry' - DMC_Data_csv$'Mid_Moist'

#Select "Spatial" data from the "Type" column in the data file
Drought_data <- subset(DMC_Data_csv, Type == "Drought")

#Select the "Context" and "meth.diff" columns and put them in their own file
context_and_methdiff_e <- select(Drought_data, "Context", "meth.diff", "diff_e")
