...
raw_data <- read_excel("DMCs_Dryad.csv")
...
context_and_methdiff <- select(Altitudinal_data, "Context", "meth.diff", "diff")

#Plot Figure 2C
Figure_2C <- ggplot(context_and_methdiff, aes(x=diff, color=Context)) +
...
#Select the "Context" and "meth.diff" columns and put them in their own file
context_and_methdiff <- select(Altitudinal_data, "Context", "meth.diff", "diff_d")

#Plot Figure 2d
Figure_2d <- ggplot(context_and_methdiff, aes(x=diff_d, color=Context)) +
...
#Select the "Context" and "meth.diff" columns and put them in their own file
context_and_methdiff <- select(Altitudinal_data, "Context", "meth.diff", "diff_e")

#Plot Figure 2e
Figure_2e <- ggplot(context_and_methdiff, aes(x=diff_e, color=Context)) +
